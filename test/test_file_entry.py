...
class TestFileEntry(unittest.TestCase):
    ...
    def test_file_entry_with_labels(self):
        ...
        labels = [
            Label("1900-01-01T05:07:10.825020+00:00", "1900-01-01T06:18:21.373460+00:00", "Stalk"),
            Label("1900-01-01T07:08:55.710520+00:00", "1900-01-01T08:35:05.321800+00:00", "Kill Phase 1")
        ]
